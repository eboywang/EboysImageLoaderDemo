...
/**
 * Executes an {@link com.hbb.event.util.AsyncExecutor.RunnableEx} using a thread pool. Thrown exceptions are propagated by posting failure events of any
...
public class AsyncExecutor {
    ...
    /** Posts an failure event if the given {@link com.hbb.event.util.AsyncExecutor.RunnableEx} throws an Exception. */
